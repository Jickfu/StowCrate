...
**M3.9 Local Durable State / config.db Schema Design & Repository Contracts** 已完成并 Review PASS；下一项为 **M3.10 config.db EF Core SQLite Implementation + Repository Tests**，实现不得让 EF schema反向定义领域模型。
